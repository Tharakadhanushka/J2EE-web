    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String duser=request.getParameter("duser");
         ...
         Connection con=(Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/deaweb", "root", "");
                  PreparedStatement st=(PreparedStatement) con .prepareStatement("DELETE FROM `user` WHERE `username`='"+duser+"'");
                  ...
                  out.println("<html><body><b><h1> Delete Successfully"+"</h1></b></body></html>");
